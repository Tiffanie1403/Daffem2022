...
CONTAINS
  ...
  !===========================================================================!
  SUBROUTINE NeumannEmb_P(Aloc, Uloc, F, ele, edgList, dist, data, iFace, iLS)
  !===========================================================================!
  ...
  END SUBROUTINE NeumannEmb_P
  !======================================================================!

END MODULE NeumannEmbedded_Primal
