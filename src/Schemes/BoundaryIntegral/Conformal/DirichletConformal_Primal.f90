MODULE DirichletConformal_Primal
...
CONTAINS
  ...
  !=============================================================================!
  SUBROUTINE DirichletConf_Primal(Aloc, Uloc, F, ele, edgList, Data, iFace, iBC)
  !=============================================================================!
  ...
  END SUBROUTINE DirichletConf_Primal
  !================================================================!

END MODULE DirichletConformal_Primal
