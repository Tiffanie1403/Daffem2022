...
CONTAINS
  ...
  subroutine pmgmres_ilu_cr ( n, nz_num, ia, ja, a, x, rhs, itr_max, mr, &
    ...
    if ( verbose ) then
       ...
       write ( *, '(a,i7)' ) '  Number of unknowns = ', n
    end if
    ...
    do itr = 1, itr_max
       ...
       do k = 1, mr
        ...
        !  if ( verbose ) then
             ...
             !IF ( MOD(K, KPrint) == 0 ) write ( *, '(a,i4,a,g14.6)' ) '  K = ', k, '  Residual = ', rho
        !  end if
  ...
  subroutine rearrange_cr ( n, nz_num, ia, ja, a )
    ...
    !  Reference:
    !
    !    Richard Barrett, Michael Berry, Tony Chan, James Demmel,rearrange_cr
    !    June Donato, Jack Dongarra, Victor Eijkhout, Roidan Pozo,
    !    Charles Romine, Henk van der Vorst,
    !    Templates for the Solution of Linear Systems:
    !    Building Blocks for Iterative Methods,
